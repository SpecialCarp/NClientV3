...
export const getPage = ({
	...
	if (language != null ||
		...
		if (language != null && typeof language === 'string' && languages.includes(language))
	...
	uni.request({
		...
		success(res) {
			...
			const gallery_list = $(".container.index-container").find(".gallery")
